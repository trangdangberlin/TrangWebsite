<div class="flex justify-around bg-black text-white py-12">
  <div class="font-bold text-2xl">TRANG WEB</div>

  <div class="bg-zinc-950 flex items-center justify-center text-white">
    <div
  ...
  <button class=" border-white bg-black hover:bg-green-600 rounded-xl px-2 hover:text-black">
    <div
