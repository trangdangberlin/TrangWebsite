...
<style>
  body {
    border: 10px solid #000; /* Adding a black border around the page */
  }
</style>
...
<div id="header" class="text-center space-y-2 pt-10 font-bold ju">
  ...
  <div>
    <button class="bg-green-500 rounded hover:bg-green-700 px-2 text-neutral-50 text-xl">
      <a href="./index.html"> Home </a>
    </button>
    <button class="bg-green-500 rounded hover:bg-green-700 px-2 text-neutral-50 text-xl">
      <a href="./aboutme.html" target="_blank"> About me </a>
    </button>
    <button class="bg-green-500 rounded hover:bg-green-700 px-2 text-neutral-50 text-xl" on:click={changeColor}>
      Change Color
    </button>
  </div>
</div>
...
<section id="diary">
  <h2 class="font-bold text-3xl text-neutral-50 text-center mt-24 bg-zinc-900 py-4">
  ...
  <h3 class="font-bold text-center text-3xl mx-auto mt-14 mb-6">
    This is a diary of what I learn every day. It will document my progress in web development throughout 2024.
  </h3>
  <h4 class="font-semibold text-2xl ml-72 my-4 mt-14">
    Let’s review what you’ve learned so far:
  </h4>
  <ol class="ml-80 list-decimal">
    <li>I added Tailwind CSS to my website</li>
    <li>19.1.2024 I learned HTML and how to integrate CSS and JS files into my index.html</li>
...
<ul class="list-disc pl-5 mt-10 ml-44">
  <li>Jan 26th: I am about to create a presentation with the topic "How to encourage young women to learn coding."</li>
  <li>Jan 25th: Coding is empowering. Once I started, I tried to focus on a problem that I wanted to solve. From there, I knew which coding language I needed, rather than learning every single language. I focused on a solution to my problem.</li>
  <li>Jan 25th: For that person, that woman, that young woman out there: Yes, coding is hard, but it is as hard for men, too. So don't give up. It can be overwhelming at the beginning, but that's where you need to continue.</li>
  <li>In 2024, I am dedicated to learning web development.</li>
  <li>I added JavaScript to my HTML code to incorporate more complex features, such as the color-changing button.</li>
  <li>I started adding a CSS file to my HTML code. It's a game-changer to style and format in one place.</li>
...
<section id="cheatsheet">
  ...
  <span style="color: green;"> &lt;h6&gt; </span> tags, are used to provide titles for sections of content.
  <span style="color: green;">&lt;p&gt;</span>, <span style="color: green;">&lt;span&gt;</span>, and
  <span style="color: green;">&lt;div&gt;</span> tags specify text or blocks. The <span style="color: green;">&lt;em&gt;</span>
  and <span style="color: green;">&lt;strong&gt;</span> tags are used to emphasize text. Line breaks are created with the
  <span style="color: green;">&lt;br&gt;</span> tag. Ordered lists (<span style="color: green;">&lt;ol&gt;</span>) are numbered,
  and unordered lists (<span style="color: green;">&lt;ul&gt;</span>) are bulleted. Images (<span style="color: green;">&lt;img&gt;</span>)
  and videos (<span style="color: green;">&lt;video&gt;</span>) can be added by linking to an existing source.
